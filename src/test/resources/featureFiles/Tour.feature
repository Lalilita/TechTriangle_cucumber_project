...
Feature: User able to search for a city and get the recommended Tour in that city

	#User able to search for a city and get the recommended Tour in that city
	@TEST_KAYAK-7
