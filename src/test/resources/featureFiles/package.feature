...
And User click and select the city of "<Departure1>" and "<Destination1>"
...
Examples:
|PKPage		|Departure1|Destination1		|StartDate		|EndDate 			 	|hotelAmountOnPage|
|packages	|IAD			 |Paris, France   |August 1 2022|August 31 2022 |16 						  |
